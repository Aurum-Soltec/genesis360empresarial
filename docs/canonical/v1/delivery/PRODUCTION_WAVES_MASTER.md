...
| --- | --- | --- |
| HSP-0 — Baseline, repositório e controle remoto | **PASS histórico; CI corretivo PASS** | GitHub organizacional, branch principal protegida, PR/CI; checks de bb290bc, dc9c124 e commit corretivo público 40b9b82 no PR #25 aprovados. Follow-up local de instrumentação/runner passou `pnpm quality` com 506 Vitest/34 nativos, sem CI remoto ou promoção. O runtime funcional sob ensaio continua bb290bc. |
