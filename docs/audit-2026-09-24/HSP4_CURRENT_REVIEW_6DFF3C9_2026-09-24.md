...
desempenho. O candidato de rota de medição do [PR #33](https://github.com/Aurum-Soltec/genesis360empresarial/pull/33),
tip `7b69a9c`, passou `corepack pnpm quality` em worktree isolada: 191
testes Vitest, 34 testes nativos de hardening, lint, tipos, segurança,
integridade, OpenAPI e build de produção Next 16.3.3. No momento desta
revisão, o CI do PR ainda falha no head anterior, e esse tip não foi
promovido ao staging. O resultado local não mede latência hospedada nem
