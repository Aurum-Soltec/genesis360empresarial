...
| --- | --- | --- |
| CI e web/worker no mesmo SHA hospedado | PASS para `bb290bc`; CI corretivo PASS sem promoção | Checks quality/database/CodeQL e deployments SUCCESS no SHA funcional. CI quality/database/CodeQL/Analyze PASS no candidato público atual `6d4d569`; web/worker ainda hospedam `bb290bc`. |
