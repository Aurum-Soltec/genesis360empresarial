...
O tip local 7b69a9c do PR público #33 passou corepack pnpm quality em worktree isolada: 191 Vitest, 34 testes nativos, lint, tipos, segurança, integridade, OpenAPI e build de produção Next 16.3.3. O CI público ainda falha no head anterior e esse tip não foi promovido ao staging. Trata-se de preparação de medição, sem causa hospedada medida ou crédito ao p95.
