...
Atualização: **2026-09-24 UTC, staging atualizado a partir de worktree limpa detached em `458aac964d1f9a7016ac1804fe99d68637a3c0b8`: HSP-4 NO-GO COM CORREÇÕES OBJETIVAS. 100 TENANTS READY: NÃO; PILOTO CONTROLADO: NO-GO; PRODUÇÃO ABERTA: NO-GO.** A [revisão A–T vigente](docs/audit-2026-09-24/HSP4_CURRENT_REVIEW_458AAC9_2026-09-24.md) separa o novo deploy de provas históricas. Nenhuma Wave posterior à HSP-4 foi iniciada.

## Estado canônico atual — fonte `458aac9`, deployments web/worker SUCCESS

O [PR #33](https://github.com/Aurum-Soltec/genesis360empresarial/pull/33) passou CI e foi integrado em `458aac964d1f9a7016ac1804fe99d68637a3c0b8`. Web Railway `65ede85d-f918-4ccf-b161-a9396d6c702a` e worker Railway `8e460f0f-4c6b-4506-b490-90682b5b1b4d` chegaram a SUCCESS a partir de worktree limpa detached no SHA exato. Railway confirmou digest web sha256:108dd4d9b0d33b5bd60d5df4fce63ca3dee62f7fc6136675d7ec6612803a613b e worker sha256:8318678e1197f06d97390dbf43629bfb88bea97963eda892ffd7ee9b234e2163; meta.commitHash=null em ambos. A vinculação de SHA vem do checkout limpo/mensagem de deploy, sem atestação nativa do provedor. A nova rota opt-in `/api/ops/home-timing` devolveu 401 anônimo; navegação direta autenticada no Chrome/IAB terminou `ERR_BLOCKED_BY_CLIENT` no cliente, sem resposta HTTP naquela tentativa. A PR privada #23 foi integrada na main `489c24a` com CI unit PASS; run protegido `36063913391` e backstop `36064075371` terminaram SUCCESS e validaram 16/16 amostras numéricas da Home no claim `458aac9`: total p50/p95 799,01/1.337,44 ms, tenant context 504,71/709,60 ms e dashboard 284,31/810,15 ms. Fixture escassa sem pains; residual local de tenant context calculado por amostra p50/p95/máximo 0,40/0,49/0,49 ms (16 completas), Auth user p95/máximo 182,30 ms: chamadas remotas predominam nessa fixture, sem causa definitiva do workload real nem correção; o p95 continua FAIL pelo último 100×60 no `bb290bc`. Evidência: `docs/audit-2026-09-24/HSP4_HOSTED_HOME_TIMING_458AAC9_2026-09-24.md`. O proprietário configurou apenas a chave anon/publicável STAGING_SUPABASE_ANON_KEY no Actions privado, sem divulgar o valor. O run HTTP multi-role hospedado 36062309891 terminou SUCCESS nos jobs exercise e independent-residue-guard, com backstop 36062480126 SUCCESS no claim `458aac9`. O runner fail-fast contém 12 assertions: 12/12 e ausência de resíduo são inferidos do resultado executável; o artefato sanitizado 10834806637 (511 bytes, sha256:96cbe42af882a26bb7a21ec135840d9783034fb747c5362297f79c5542399840) não foi inspecionado independentemente. O subgate HTTP recebe PASS limitado pela proveniência externa do deployment (Railway meta.commitHash=null); FULL fictício e worker/outbox ainda precisam de revalidação no `458aac9`. Após reload real da IAB em `/demonstracao/administracao`, owner sintético do Tenant A viu Agentic, Data Upload real, Qualification Network, Real Contact e Ecosystem DESLIGADA, com resumo de cinco funções desligadas; navegação direta `/ecossistema` retornou 404. É PASS visual/de rota limitado a essa sessão, sem inspeção bruta de env ou outros serviços. Evidência: `docs/audit-2026-09-24/HSP4_HOSTED_HTTP_MULTIROLE_458AAC9_2026-09-24.md`. O backup schedule 36041370015 foi SKIPPED/OFF; issue privada #17 segue aberta após e-mail externo e ACK humano confirmados; dry-run posterior apenas comprovou wiring, sem recuperação real. Backup/RPO-RTO e NOTICE seguem BLOCKED. A [revisão A–T vigente](docs/audit-2026-09-24/HSP4_CURRENT_REVIEW_458AAC9_2026-09-24.md) detalha os gates.

A PR privada #22 foi integrada na main `7759ac15e15220f56b6a5ed3888738f9c3d27238` (head `44953e`) com CI unit PASS. Run sintético `36063130004` SUCCESS: resumo sanitizado informado de 3 Auth, 2 tenants, 24 migrations, 4 outbox processados, paridade de catálogo e `same_tenant_role_matrix_tested=true`, mas `storage_bytes_restored_from_backup=false`. Até worker 188,167 s é tempo sintético, não RTO de serviço. A PR privada #25 foi integrada em `0d94e17fddca631e3bdbd1ef3c4c083cca94e19b`; run sintético `36067300522` SUCCESS comparou 71 bytes fictícios source→target por bytes/SHA e verificou catálogo, owner, ACL, RLS e limpeza, ainda com `storage_bytes_restored_from_backup=false`. A PR privada #27 foi integrada em `381bce1671bb405c2384ef289bed7944b1fb9dc8`; run `36067885407` induziu falha antes de secrets/DB/Storage, e o job de alerta SUCCESS mencionou `@hudsonlcustodio` na issue privada #17 (comentário `5823303209`). Entrega por e-mail externo e ACK humano foram confirmados (metadados 22:44:52Z); o dry-run do monitor `36069498641` retornou `dry_run_pass` sem release/DB/Storage e não atualizou a issue #17, ainda OPEN. O agente não inspecionou independentemente o artefato privado de restore; cron backup permanece OFF e HSP-2 BLOCKED. Evidência: `docs/audit-2026-09-24/HSP4_PRIVATE_SYNTHETIC_AND_SQL_METADATA_2026-09-24.md`.

A PR privada #26 integrou em `5ba5bcf13ef8149cdafd6aecb840334a85c33c16` (CI PASS) a medição ampliada da Home. O run `36068483011` PASS executou 200 GETs autenticados em **um tenant** scored com três dores (100 membro/100 gestor), limpeza primária e guard de 14 categorias sem resíduo. Total p50/p95/p99/máximo **728,55/1.229,81/1.758,33/3.902,15 ms**, 77/200 acima de 750 ms; o p95 membro foi 1.237,05 ms e gestor 1.133,92 ms. Fases apontam custo de chamadas remotas e cauda de quota, mas não provam causalidade. Região do runner GitHub não foi confirmada como Brasil, e o método de score da fixture não foi validado. O run não substitui **100 empresas por 60 minutos**, não comprova correção e não altera HSP-3 FAIL/HSP-4 NO-GO. Evidência: `docs/audit-2026-09-24/HSP4_HOSTED_HOME_TIMING_458AAC9_2026-09-24.md`.

Uma inspeção OSS temporária read-only nos deployments atuais web/worker `458aac9` encontrou **30/30 hashes de pacotes iguais ao CI em cada serviço**, 28 LICENSE/NOTICE, 3 binários nativos e zero pacote ausente. IDs/digests permaneceram inalterados e a chave temporária foi removida. O [arquivo detalhado versionado](docs/audit-2026-09-24/HSP4_OSS_NOTICE_REVIEW_458AAC/HOSTED_IMAGE_BYTES_458AAC.md) registra o alcance e os limites dessa inspeção; isso dá apenas crédito técnico aos bytes dos pacotes, **não** fecha NOTICE final nem decisão jurídica LGPL/CC-BY/MPL. HSP-2 e HSP-4 permanecem bloqueados.

Não trocar `getUser` por `getClaims` no core nem mover o banco/região com essas amostras curtas: a economia máxima Auth user de 182,30 ms na primeira fixture não cobre sozinha a diferença ao SLO, e o login brasileiro→Auth não foi medido no canário. Canário sintético em us-east-1 depende de slot/orçamento Free e deve comparar login Brasil→Auth e Home com diagnóstico/três dores em carga representativa; a segunda amostra tem três dores, porém somente um tenant e região de runner não verificada. JWT assimétrico/revogação, efeito regional e residência de dados exigem prova, ADR/decisão e validação Auth/Storage/ACL/RLS/backup com novo 100×60 antes de qualquer promoção estrutural.

## Registro histórico — fonte `6dff3c9`, deployments web/worker SUCCESS

O [PR #30](https://github.com/Aurum-Soltec/genesis360empresarial/pull/30) corrigiu o vínculo contextual das três fontes fictícias; um [FULL hospedado no SHA `5b992d3`](docs/audit-2026-09-24/HSP4_HOSTED_FULL_DEMO_5B992D3_2026-09-24.md) completou 52 respostas, score 51, confiança 78% e cockpit **7/7**, com zero referências por resposta e zero fontes verificadas. O [PR #31](https://github.com/Aurum-Soltec/genesis360empresarial/pull/31) integrou instrumentação numérica adicional da Home em `ff864213`. O [PR #32](https://github.com/Aurum-Soltec/genesis360empresarial/pull/32) passou CI e foi integrado em `6dff3c9` com emissão de fases da Home no stdout Node. Uploads CLI de uma worktree local limpa nesse SHA terminaram SUCCESS no web `2e2690bd` (digest `sha256:d588f39244cb6a5836eaf8e1fb0a1b7bae0f560a4421893cbad93653fb78c5b9`) e worker `56740353` (digest `sha256:d13cd6b36bd403afccce55beda7612fe00ae2ace9477e068e39b6287e7da14c4`). Railway registra a mensagem CLI com esse SHA, mas `meta.commitHash=null` nos dois deployments: **a identidade do commit não foi atestada nativamente pelo provedor**. O FULL 7/7 pertence a `5b992d3`; não há novo FULL em `6dff3c9`. Análise de documentos reais segue desabilitada.

A migration 0024 segue aplicada. O isolamento SQL 12/12 e HTTP multi-role 12/12 passou historicamente no `bb290bc`. O [workflow privado SQL-only](docs/audit-2026-09-24/HSP4_PRIVATE_SYNTHETIC_AND_SQL_METADATA_2026-09-24.md) `36031065644` passou no predecessor `ff864213`, e o **reteste pinado à fonte `6dff3c9`**, run `36035020570`, também terminou SUCCESS: validador fail-closed exige exatamente 12 casos nomeados, contagens e rollback com resíduo `[0,0,1,0]`. Execução e upload do artefato sanitizado passaram; seu JSON privado não foi inspecionado independentemente pelo agente devido à revisão automática. Esse **PASS limitado ao SQL** não substituía, naquele momento, HTTP Auth de membro, gestor e outro tenant; o run hospedado posterior 36062309891 deu PASS limitado a esse subgate no claim `458aac9`. O último soak completo no `bb290bc` durou 3.604 s com 100 tenants, zero erro inesperado e outbox 5.806/5.806, mas falhou p95 ≤750 ms em login, Home, escrita e leitura. Não há repetição 100×60 na fonte atual nem correção causal demonstrada.

A PR privada #19 integrou o runner manual HTTP multi-role. Um ensaio **local isolado** passou três logins reais GoTrue e limpou 11 categorias de fixtures, mas **não havia executado HTTP no staging naquele momento**. O proprietário posteriormente configurou a chave anon/publicável `STAGING_SUPABASE_ANON_KEY` diretamente nos secrets da Actions privada, sem expor o valor, e o run hospedado 36062309891 passou com guard independente e backstop SUCCESS.

O backup privado v2 tem release cifrada e restore lógico isolado; o boot de uma stack sintética **vazia** em loopback passou em Ubuntu. O [ensaio privado source→target sintético](docs/audit-2026-09-24/HSP4_PRIVATE_SYNTHETIC_AND_SQL_METADATA_2026-09-24.md), run `36030761200`, concluiu SUCCESS sem credenciais ou backup real do staging; não fornece prova de restore real do serviço, RPO/RTO, retenção ou ACL/owner equivalentes. A PR privada #18 foi integrada no SHA `352811cf15325065ff9c320c216c43b5c2946001` como preflight de release imutável controlada pelo operador; 8 testes focados e suíte 70 PASS com 1 symlink SKIP no Windows, **sem execução com chave ou backup real** e sem crédito de RPO/RTO. A PR privada #20 integrou no SHA `c3adbe3c57e943ffc8712f6fe4e9ff05e5f22dc0` uma guarda de retenção: só poda após confirmar que a release imutável desta execução foi baixada, teve hash verificado e é a mais recente; listagem malformada falha fechado. CI unitário passou 77 testes sintéticos. Isso é preparação de código, sem cron ativo, retenção histórica medida, backup ou restore real. O drill inicial de alerta específico do backup abriu a issue privada #17; **o ACK humano estava pendente naquele checkpoint**. O ensaio posterior confirmou e-mail/ACK, mas não recuperação real. Cron segue OFF. A [inspeção OSS no SHA `25c022d8`](docs/audit-2026-09-24/HSP4_DEPLOYED_LICENSE_BYTES_25c022d8.md) conferiu os 30 pacotes sob revisão com o CI daquele SHA, mas NOTICE final e decisão jurídica LGPL/CC-BY/MPL permanecem pendentes; o [pacote de revisão de licenças](docs/audit-2026-09-24/HSP4_OSS_NOTICE_REVIEW_31df6086/NOTICE_INDEX.md) é insumo técnico, não aprovação. Não há crédito automático para as imagens novas. No web predecessor enviado da fonte `6dff3c9`, a UI autenticada de proprietário sintético do Tenant A em `/demonstracao/administracao` exibiu **Agentic, Data Upload real, Qualification Network, Real Contact e Ecosystem como DESLIGADA**, além do resumo “Cinco funções sensíveis desligadas”. A navegação direta para `/ecossistema` retornou **404**, coerente com bloqueio dessa superfície. Isso fecha a verificação **visual/de rota das cinco flags nesse contexto**, sem equivaler a inspeção bruta de variáveis de ambiente; elas devem continuar false em cada promoção.

A PR privada #21 foi integrada em d8bdfb8d4065883d76852cca2ad908baf626f8a9: 88 testes sintéticos no CI e dry-run 36039829373 SUCCESS. O monitor fica com cron OFF por padrão; o dry-run não leu release real nem abriu issue. Backup e monitor compartilham o GitHub Actions como domínio de falha. Isso é preparação sem prova de alerta independente, backup automático, restore ou RPO/RTO.

O PR público #33 integrou a rota autenticada de medição de fases da Home na main SHA 458aac964d1f9a7016ac1804fe99d68637a3c0b8 após CI PASS. O tip 7b69a9c passou corepack pnpm quality em worktree isolada: 191 Vitest, 34 testes nativos, lint, tipos, segurança, integridade, OpenAPI e build de produção Next 16.3.3. A rota foi implantada e negou a chamada anônima; naquele momento a execução autenticada estava pendente. O run protegido posterior `36063913391` produziu 16 amostras, sem causa definitiva isolada nem crédito ao p95 100×60.

No web predecessor `6dff3c9`, dois GETs autenticados da Home retornaram HTTP 200 em **2.287 ms** e **14 ms**. Os logs filtrados por `home_latency` não mostraram eventos de fase. Uma tentativa de inspeção ampla dos logs foi rejeitada pela revisão automática por possível conteúdo sensível e não foi contornada. Essas amostras não permitem inferir p95 ou gargalo; a instrumentação ainda não forneceu medida causal hospedada e não corrige desempenho.

**Falta fechar:** (1) preservar o PASS limitado do HTTP multi-role na fonte atual e fechar a lacuna de atestação nativa de proveniência Railway; (2) backup automático com retenção, restore completo de serviço e RPO/RTO medidos, além de alerta específico com ACK; (3) NOTICE, decisão OSS e bytes das imagens finais; (4) obter medidas causais seguras, corrigir o gargalo e repetir 100 empresas/60 minutos com p95 ≤750 ms; (5) repetir gates afetados e emitir novo GO/NO-GO. Os percentuais históricos Fundação 92%, MVP 82%, V1 64% não recebem crédito adicional da demo fictícia.

## Registro histórico da revisão no SHA `31df6086` — 2026-09-24 UTC

Os parágrafos desta seção registram o estado daquela promoção. Referências a
"runtime atual", correções locais e pendências de demo 6/7 devem ser lidas
**na data do SHA `31df6086`**; prevalece o estado canônico `6dff3c9` acima.

O [PR #25](https://github.com/Aurum-Soltec/genesis360empresarial/pull/25) foi integrado e o SHA `31df6086cb612886dc5db4a45b946ea80dde2cf1` está em **web e worker SUCCESS** no staging isolado (deployments `09f91585-1ec8-47d9-9b2c-5c40950527f0` e `86828bcf-dd39-44a7-a94d-ef5819da766f`). Os checks finais quality/database/CodeQL/Analyze passaram. No SHA promovido, as rotas anônimas protegidas negaram acesso; uma sessão autenticada selecionou Tenant A e leu administração, Passport, demo e relatório. A demo mostrou **6/7 etapas**, distinguindo três fontes fictícias registradas de **zero vinculadas/verificadas**; o relatório existente apresentou 55 respostas, score 48, confiança 78, plano de 90 dias e três empresas explicitamente fictícias, com zero referências por resposta, zero fontes vinculadas e zero verificadas. Diagnóstico, Evolução, Soluções e Conselho abriram seus destinos nesta checagem limitada. O proprietário entrou novamente com a conta exata convidada, observou somente Tenant A e Auth registrou `last_sign_in_at` posterior ao reteste: o subgate de novo login passou.

A migration 0024 e o isolamento entre membro, gestor e outro tenant passaram 12/12 SQL e 12/12 HTTP **no SHA anterior `bb290bc7bc35f77b4ca01aecdbf19b748c386270`**. Eles não foram repetidos no SHA `31df6086` e permanecem pendentes para crédito do novo artefato. O roteiro sintético corrigido foi tentado antes da promoção com duas contas de teste protegidas: ambas passaram Auth, porém o runner retornou zero opções de tenant e não escreveu. Após a promoção, a UI autenticada para `user-a@genesis.test` encontrou Tenant A; portanto a ausência de membership da fixture **não está comprovada**. A causa da discrepância é desconhecida, e a prova de um novo relatório com proveniência corrigida continua pendente. Análise de documento real permanece sob a flag OFF.
...
O [ensaio manual privado da stack sintética vazia](docs/audit-2026-09-24/HSP4_PRIVATE_SYNTHETIC_STACK_BOOT_2026-09-24.md), PR #11 integrada no SHA `987964fc511eea4d95e03405ef12bc2283bd816b`, run `36020411581` SUCCESS, iniciou o ambiente isolado Ubuntu gratuito e verificou saúde, identidade e portas somente em loopback, com limpeza ao final. Boot/saúde levaram 120 s, com recursos disponíveis após iniciar; isso supera apenas o bloqueio de **boot seguro da stack vazia**. Nenhum backup ou dado foi restaurado, portanto os 120 s não são RTO e não há RPO, equivalência de ACL/owner ou retorno de serviço comprovados. Schedule permanece OFF e HSP-2 segue BLOCKED.

A carga integral histórica de 100 empresas por 3.604 s passou duração, 584 negativas cross-tenant esperadas e 5.806/5.806 eventos outbox processados, mas **falhou p95 ≤750 ms** em login (1.964,5), Home (1.055,48), escrita (1.024,5) e leitura (793,8 ms). Ela não foi repetida após a promoção. A amostra causal adicional mediu Home gzip 5.681 bytes, primeiro byte rápido, streaming SSR lento e picos Auth; não há correção pequena segura demonstrada. Instrumentação numérica das subfases de tenant-context e da API de fatos passou 27 testes focados e foi implantada com `31df6086`, mas ainda não gerou nova medição hospedada e não é correção de latência. Há uma instrumentação adicional da Home e uma correção de vínculo contextual das três fontes fictícias **somente locais**; testes locais passaram, mas faltam CI, promoção e execução hospedada para crédito runtime. O último commit com alterações de código do PR #25 é `6d4d569be50acc03999eebb23faa1dfc10fc7725`: o run local histórico relatou 506 Vitest/34 testes nativos, e os checks finais passaram nos runs remotos `36009033246` e `36009024373`. A configuração Vitest daquela contagem não excluía a pasta temporária ignorada; ela não é comparável à suíte limpa atual. Após restringir a descoberta de testes ao repositório, a suíte local atual passou **49 arquivos/181 testes**; esse resultado também é local e posterior à promoção.

A variável `HSP4_PERF_TRACE=1` foi configurada no web staging com `--skip-deploys`; ela só entrará em vigor no próximo deployment web. Nenhuma medição de subfases da Home foi produzida por essa configuração e o p95 continua FAIL.

A [inspeção read-only dos contêineres web e worker no SHA `31df6086`](docs/audit-2026-09-24/HSP4_DEPLOYED_LICENSE_BYTES_31df6086.md) comparou **30/30 pacotes fora da preferência ADR-015** com o inventário Linux do CI do mesmo SHA: 454 dependências instaladas por serviço e zero divergência de hash agregado nesses 30 pacotes. Assim, a lacuna de presença/bytes **desses pacotes** está fechada para esse deployment. Inclusive os 21 classificados fora da árvore `pnpm --prod` estão fisicamente nas imagens. O binário libvips LGPL consta em ambas; três pacotes não trouxeram arquivo LICENSE/NOTICE local. NOTICE completo, condições de distribuição e decisão técnica/jurídica LGPL/CC-BY/MPL permanecem **BLOCKED**, sem aprovação implícita. A prova não é hash integral da imagem e perde validade após novo deployment. Cinco flags sensíveis permaneceram OFF na UI promovida. Fundação 92%, MVP 82% e V1 64% permanecem estimativas históricas, sem crédito de prontidão operacional.

O [pacote técnico para revisão de licenças](docs/audit-2026-09-24/HSP4_OSS_NOTICE_REVIEW_31df6086/NOTICE_INDEX.md) reúne manifesto dos 30 pacotes, 28 textos LICENSE/NOTICE copiados e verificados do CI do mesmo SHA e fontes primárias para três lacunas de arquivo local. Ele facilita a decisão, mas **não é NOTICE final nem aprovação jurídica**; a verificação das demais dependências e das condições das bibliotecas incorporadas permanece aberta.
